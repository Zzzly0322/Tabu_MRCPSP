    ...
    def resource_Tuba(self,disruption_time,resolution,plan_finish_time,itertimes):
        ...
        while count1<itertimes:
            ...
            for i in range(20):
                ...
                tabu_list.append(move_set[exceed_cost1.index(min(exceed_cost1))])
        ...
        print("min(exceed_resource)",min(exceed_cost2))
        print("group:",finall_cost_group2[exceed_cost2.index(min(exceed_cost2))])

        print(finall_model2[exceed_cost2.index(min(exceed_cost2))])
        print(finall_solution2[exceed_cost2.index(min(exceed_cost2))])
...
file=os.path.abspath(os.path.dirname(os.path.dirname(__file__)))+"\data\j14.mm\j141_8.mm"
...
finall_solution,finall_model=ins.resource_Tuba(ins.disruption_time,listr,finish_time[-1],100)
print("------------------------我是分割线--------------------------------")
