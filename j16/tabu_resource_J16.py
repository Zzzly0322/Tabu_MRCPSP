...
class Instance():
    ...
    def resource_Tuba(self,disruption_time,resolution,plan_finish_time,itertimes):
        ...
        doc = open('out.txt', 'a')
        print("exced_cost2",exceed_cost2)
...
file = os.path.abspath(os.path.dirname(os.path.dirname(__file__))) + "\data\j14.mm\j143_10.mm"
ins = Instance()
ins.loadData(file)
...
for dis_time in range(1,16):
    file = os.path.abspath(os.path.dirname(os.path.dirname(__file__))) + "\data\j14.mm\j146_3.mm"
    ins = Instance()
    ins.loadData(file)
...
"""
best model 
 [1, 1, 3, 2, 2, 1, 1, 1, 1, 1, 1, 3, 2, 2, 1, 1, 2, 1]
best solution 
 [1, 3, 2, 5, 6, 4, 14, 13, 10, 7, 8, 12, 9, 15, 11, 17, 16, 18]
best time 
 30.0
start_time [0, 0, 0, 0, 3, 12, 13, 14, 14, 13, 15, 16, 13, 10, 19, 19, 21, 30] 
 finish_time [0, 3, 10, 8, 12, 13, 14, 15, 15, 16, 18, 21, 15, 19, 24, 20, 30, 30]
renewable_resource: [4, 4, 4, 3, 3, 3, 3, 3, 3, 3, 0, 0, 0, 5, 9, 6, 4, 4, 0, 4, 4, 5, 5, 5, 1, 1, 1, 1, 1, 1] 
 [3, 3, 3, 10, 10, 10, 10, 10, 7, 7, 12, 12, 13, 7, 15, 5, 12, 12, 12, 15, 7, 0, 0, 0, 0, 0, 0, 0, 0, 0]
unrenewable_resource: 51 
 32
